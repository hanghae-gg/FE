...
class Map extends Component {
  ...
  componentDidMount() {
    ...
    script.src = "https://dapi.kakao.com/v2/maps/sdk.js?appkey=f36562af99b499dbbf4e86ab295001fd";
  ...
  handleTest = () => {
    ...
    kakao.maps.load(() => {
      //지도를 정보를 바꾸기 위한 LagLng객체를 만들기 위해 로드
  ...
  handleCreate = (data) => {
    // Inputs에서 받아온 값으로 좌표를 이동시키기 위한 함수
    let createX = parseFloat(data.Lat),
      createY = parseFloat(data.Lng);
    this.setState({
      x: createX,
      y: createY,
    });
